...
@section('content')
    <div>
        <div class="text-center p-10">
            <h1 class="font-bold text-4xl mb-4">Tất cả sản phẩm</h1>
        </div>
        <section id="Projects"
            class="w-max mx-auto grid grid-cols-1 lg:grid-cols-4 md:grid-cols-4 justify-items-center justify-center gap-y-20 gap-x-14 mt-10 mb-5">
            @if (isset($data))
                        ...
                        <a href="{{ route('product.detail', $product->id) }}">
                            ...
                            <div class="px-4 py-3 w-72">
                                ...
                                <div class="flex items-center">
                                    <p class="text-lg font-semibold text-black cursor-auto my-3">{{ number_format($product->price) }}</p>
                                    <del>
                                        <p class="text-sm text-gray-600 cursor-auto ml-2">{{ number_format($product->sale_price) }}</p>
                                    </del>
