        ...
        <div class="container">
            ...
            <section class="px-8 mt-8 mb-5">
                <div class="w-full flex justify-between items-center">
                    ...
                    <a href="#"
                        class="px-6 py-3 text-red-500 font-semibold rounded-lg hover:text-red-600 transition">Tất cả</a>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-5">
                    ...
                    <div class="rounded-lg overflow-hidden border border-gray-300 shadow-lg flex flex-col bg-white">
                        ...
                        <div class="px-6 py-3 flex justify-between bg-gray-100">
                            ...
                            <button class="px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition">Thêm <i
                ...
                <div class="container mx-auto px-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div class="bg-white rounded-lg shadow-lg p-8">
                            ...
                            <p class="text-gray-500 text-sm mt-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                            </p>
                            <div class="flex items-center justify-between mt-4">
                                <span class="text-gray-900 font-bold text-lg">$29.99</span>
                                <button
                                    class="bg-gray-900 text-white py-2 px-4 rounded-full font-bold hover:bg-gray-800">Thêm
                                    vào giỏ</button>
                            </div>
                        </div>
                        <div class="bg-white rounded-lg shadow-lg p-8">
            ...
            <section class="bg-white dark:bg-gray-900">
                <div class="text-center py-10">
                    ...
                    <p class="text-lg text-gray-600 dark:text-gray-400">Khám phá, tìm hiểu và lấy cảm hứng từ những hành
                        trình thú vị.</p>
                </div>
                        ...
                        <div class="relative">
                            ...
                            <div class="relative mt-5">
                                ...
                                <a href="#" class="block mb-3 hover:underline">
                                    <h2
                                        class="text-2xl font-bold leading-5 text-black dark:text-white transition-colors duration-200 hover:text-purple-700">
                                        Chuyến đi đến núi</h2>
                                </a>
                                <p class="mb-4 text-gray-700 dark:text-gray-300">Thoát khỏi sự hối hả và khám phá vẻ đẹp yên
                                    bình của núi rừng.</p>
                                <a href="#" class="font-medium underline text-purple-600 dark:text-purple-400">Đọc
                                    thêm</a>
                            </div>
                        </div>
                        <div class="relative">
                            ...
                            <div class="relative mt-5">
                                ...
                                <p class="mb-4 text-gray-700 dark:text-gray-300">Thoát khỏi sự hối hả và khám phá vẻ đẹp
                                    yên bình của núi rừng.</p>
                                <a href="#" class="font-medium underline text-purple-600 dark:text-purple-400">Đọc
                                    thêm</a>
                            </div>
                        </div>
